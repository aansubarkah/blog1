...
set shortmess+=A                        " don't give ATTENTION message when an existing swap file is found
...
" Generate a .ctags file per project
...
"
" dbext MySQL {
let g:dbext_default_profile_mysql_local = 'type=MYSQL:user=user:passwd=jayapura'
"}
" UndoTree {
...
if has('gui_running')
    ...
    if !exists("g:spf13_no_big_font")
        if LINUX() && has("gui_running")
            set guifont=Meslo\ LG\ L\ DZ\ for\ Powerline,SourceCodePro,UbuntuMono,Andale\ Mono\ Regular\ 12,Menlo\ Regular\ 11,Consolas\ Regular\ 12,Courier\ New\ Regular\ 14
        elseif OSX() && has("gui_running")
            set guifont=SourceCodePro,UbuntuMono,Andale\ Mono\ Regular:h12,Menlo\ Regular:h11,Consolas\ Regular:h12,Courier\ New\ Regular:h14
        elseif WINDOWS() && has("gui_running")
            set guifont=SourceCodePro,UbuntuMono,Andale_Mono:h10,Menlo:h10,Consolas:h10,Courier_New:h10
        endif
    endif
else
